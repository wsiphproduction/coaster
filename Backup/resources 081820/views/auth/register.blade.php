    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <br><div class="card-header" style="font-weight: bold">{{ __('Account Registration') }}</div><br>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="username" class="col-md-4 col-form-label text-md-right">{{ __('Domain Name') }}</label>
