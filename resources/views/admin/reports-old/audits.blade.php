                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light bordered">
                            ...
                            <div class="pull-right">
                                {!! $audits->previousPageUrl() ? '<a href='. $audits->previousPageUrl().'>Previous Page</a>'  : '' !!}
                                {!! $audits->nextPageUrl() ? '&nbsp;&nbsp;<a href='. $audits->nextPageUrl().'>Next Page</a>'  : ''!!}
                            </div>
                            <table class="table table-striped table-hover" id="sample1">
                                <thead>
                                    <tr>
