...
<div class="main">
    ...
    <div class="container" id="maincontent" style="width: 1440px!important;">
        <ul class="blog-info">
            ...
            <li> <img src="images/booked_seat_img.gif"> Taken</li>
            <li style="display:none;"> <img src="images/stall.png"> Stool</li>
        </ul><br>
                                    ...
                                    <div class="col-md-10 col-sm-10">
                                        <ul style="z-index:1000;" id="place">
                                            @php
                                                ...
                                                $left = -55;
                                                $stallSeat= [];
                                                $seats_with_top_margin = [3,7,11,15,19,23,27,31,35,39];
                                                $margin = 55;
                                            @endphp
                                            @foreach ($seatArray as $arr)
                                                @php
                                                    ...
                                                    if($col >= 11){
                                                        ...
                                                        if(in_array($arr, $seats_with_top_margin)){
                                                            $margin = 110;
                                                        }                                                       
...
// Start calling form
                                            $.ajax({
                                                ...
                                                url: "ajax?act=selectseat&ph=- Origin/Pickup -",
                                                data: {
